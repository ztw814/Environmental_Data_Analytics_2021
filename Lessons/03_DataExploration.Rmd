...
#use ../ if the working directory is set to a folder within the project (../ means go outside the wd back to the main folder); use ./ if the working directory is already set to the main folder
...
#
create.early.dates <- (function(d) {      #paste0 adds something to the beginning of the string
